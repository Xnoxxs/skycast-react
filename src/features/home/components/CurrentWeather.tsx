...
import { generateWeatherRecommendations } from "#features/weather/utils/generateWeatherRecommendations"
...
const CurrentWeather: React.FC<{
  ...
  const recommendations = data ? generateWeatherRecommendations(data) : []
